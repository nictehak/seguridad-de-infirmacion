...
@section('main-content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">usuario {{ $users->id }}</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <th> Numero </th><td> {{ $users->id }} </td></tr>
    
                                    <th> Nombre </th><td> {{ $users->name  }} </td></tr><th> Email </th><td> {{ $users->email }} </td></tr>

                                      <th> Perfil </th><td> {{ $users->Perfil->nombre  }} </td></tr>
